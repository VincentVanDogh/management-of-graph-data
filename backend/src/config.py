...
COMMUNITIES_SUBJECTS_CSV = "community_subject.csv"

# Property Graph output file paths
...
COMMUNITIES_PROPERTY_GRAPH_JSON = fr"{PROPERTY_GRAPHS_OUTPUT}/communities.json"